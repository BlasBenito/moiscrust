...
The resulting table, `moiscrust_weather`, now has daily observations of soil humidity coupled with daily weather data.
...
if(!file.exists("database.zip")){
  ...
  readr::write_excel_csv(
    ...
    readr::write_excel_csv(
    x = moiscrust_weather,
    file = "database/moiscrust_weather.csv"
  )
