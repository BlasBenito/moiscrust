...
The MOISCRUST database has several negative values falling within the margin of error of the sensors. To remove these anomalous values we set them to zero.
