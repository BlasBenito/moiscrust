...
\hline
retama\_1 & retama\_2 & retama & retama & TRUE & 19.49132 & 0.8875375 & 1 & 208.2451\\
\hline
retama\_1 & retama\_3 & retama & retama & TRUE & 32.26840 & 0.9050852 & 2 & 222.7769\\
\hline
retama\_1 & stipa\_1 & retama & stipa & FALSE & 49.39264 & 0.8768781 & 3 & 137.0805\\
\hline
retama\_1 & stipa\_2 & retama & stipa & FALSE & 30.86449 & 0.8693809 & 4 & 117.8026\\
\hline
retama\_1 & stipa\_3 & retama & stipa & FALSE & 32.64464 & 0.9077454 & 5 & 123.4192\\
\hline
retama\_1 & bare\_soil\_1 & retama & bare\_soil & FALSE & 49.00995 & 0.8918511 & 6 & 138.1951\\
\hline
retama\_1 & bare\_soil\_2 & retama & bare\_soil & FALSE & 40.65960 & 0.7716887 & 7 & 117.8285\\
\hline
retama\_1 & bare\_soil\_3 & retama & bare\_soil & FALSE & 12.33204 & 0.8942298 & 8 & 101.7550\\
\hline
retama\_1 & biocrust\_medium\_1 & retama & biocrust\_medium & FALSE & 45.66465 & 0.9131358 & 9 & 136.9782\\
\hline
retama\_1 & biocrust\_medium\_2 & retama & biocrust\_medium & FALSE & 35.28691 & 0.7624165 & 10 & 111.5286\\
\hline
retama\_1 & biocrust\_medium\_3 & retama & biocrust\_medium & FALSE & 21.96805 & 0.8633835 & 11 & 108.3064\\
\hline
retama\_1 & biocrust\_high\_1 & retama & biocrust\_high & FALSE & 48.26823 & 0.8719324 & 12 & 135.4615\\
\hline
retama\_1 & biocrust\_high\_2 & retama & biocrust\_high & FALSE & 43.13633 & 0.8749174 & 13 & 130.6281\\
\hline
retama\_1 & biocrust\_high\_3 & retama & biocrust\_high & FALSE & 35.61585 & 0.9401687 & 14 & 129.6327\\
\hline
retama\_2 & retama\_3 & retama & retama & TRUE & 35.53845 & 0.8520638 & 15 & 220.7448\\
\hline
retama\_2 & stipa\_1 & retama & stipa & FALSE & 38.00658 & 0.7677740 & 16 & 114.7840\\
\hline
retama\_2 & stipa\_2 & retama & stipa & FALSE & 38.66016 & 0.8345871 & 17 & 122.1189\\
\hline
retama\_2 & stipa\_3 & retama & stipa & FALSE & 32.43824 & 0.8913270 & 18 & 121.5709\\
\hline
retama\_2 & bare\_soil\_1 & retama & bare\_soil & FALSE & 44.80683 & 0.7984693 & 19 & 124.6538\\
\hline
retama\_2 & bare\_soil\_2 & retama & bare\_soil & FALSE & 45.83235 & 0.7608700 & 20 & 121.9193\\
\hline
\end{tabular}}
\end{table}
...
retama\_2 & bare\_soil\_2 & retama & bare\_soil & FALSE & 45.83235 & 0.7608700 & 20 & 121.9193\\
\hline
retama\_2 & bare\_soil\_3 & retama & bare\_soil & FALSE & 29.17034 & 0.8402989 & 21 & 113.2002\\
\hline
retama\_2 & biocrust\_medium\_1 & retama & biocrust\_medium & FALSE & 31.35038 & 0.7975457 & 22 & 111.1049\\
\hline
retama\_2 & biocrust\_medium\_2 & retama & biocrust\_medium & FALSE & 33.47666 & 0.7376920 & 23 & 107.2459\\
\hline
retama\_2 & biocrust\_medium\_3 & retama & biocrust\_medium & FALSE & 27.62454 & 0.8515719 & 24 & 112.7817\\
\hline
retama\_2 & biocrust\_high\_1 & retama & biocrust\_high & FALSE & 45.04762 & 0.7545435 & 25 & 120.5020\\
\hline
retama\_2 & biocrust\_high\_2 & retama & biocrust\_high & FALSE & 45.04977 & 0.8237431 & 26 & 127.4241\\
\hline
retama\_2 & biocrust\_high\_3 & retama & biocrust\_high & FALSE & 31.08808 & 0.8414304 & 27 & 115.2311\\
\hline
retama\_2 & retama\_1 & retama & retama & TRUE & 19.49132 & 0.8875375 & 106 & 208.2451\\
\hline
\end{tabular}}
\end{table}
...
\NormalTok{        )}\SpecialCharTok{$}\NormalTok{fit}
    ...
    \CommentTok{\#replacing negative values with 0}
    \ControlFlowTok{if}\NormalTok{(prediction[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{\textless{}} \DecValTok{0}\NormalTok{)\{}
\NormalTok{      prediction[}\DecValTok{1}\NormalTok{] }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{    \}}
    \ControlFlowTok{if}\NormalTok{(prediction[}\DecValTok{2}\NormalTok{] }\SpecialCharTok{\textless{}} \DecValTok{0}\NormalTok{)\{}
\NormalTok{      prediction[}\DecValTok{2}\NormalTok{] }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{    \}}
    \ControlFlowTok{if}\NormalTok{(prediction[}\DecValTok{3}\NormalTok{] }\SpecialCharTok{\textless{}} \DecValTok{0}\NormalTok{)\{}
\NormalTok{      prediction[}\DecValTok{3}\NormalTok{] }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{    \}}
    
    \CommentTok{\#save prediction}
\NormalTok{    y[row\_i, }\FunctionTok{c}\NormalTok{(}
      \StringTok{"model\_estimate"}\NormalTok{, }
      \StringTok{"model\_ci\_lower"}\NormalTok{, }
      \StringTok{"model\_ci\_upper"}
\NormalTok{      )] }\OtherTok{\textless{}{-}}\NormalTok{ prediction}
...
\NormalTok{moiscrust\_long}\SpecialCharTok{$}\NormalTok{interpolation\_quality }\OtherTok{\textless{}{-}}\NormalTok{ moiscrust\_long}\SpecialCharTok{$}\NormalTok{sensors\_r\_squared}

\CommentTok{\#filling NA with "observation"}
\NormalTok{moiscrust\_long[}
  \FunctionTok{is.na}\NormalTok{(moiscrust\_long}\SpecialCharTok{$}\NormalTok{interpolation\_quality), }
  \StringTok{"interpolation\_quality"}
...
\hline
bare\_soil\_1 & 18442 & 11338 & 39.6 & 24.4\\
\hline
bare\_soil\_2 & 27546 & 16872 & 59.2 & 36.3\\
\hline
bare\_soil\_3 & 34707 & 4191 & 74.6 & 9.0\\
\hline
biocrust\_high\_1 & 22940 & 12442 & 49.3 & 26.7\\
\hline
biocrust\_high\_2 & 18813 & 6558 & 40.4 & 14.1\\
\hline
biocrust\_high\_3 & 24225 & 5640 & 52.1 & 12.1\\
\hline
biocrust\_medium\_1 & 25797 & 7906 & 55.5 & 17.0\\
\hline
biocrust\_medium\_2 & 29532 & 9232 & 63.5 & 19.8\\
\hline
biocrust\_medium\_3 & 30596 & 5509 & 65.8 & 11.8\\
\hline
retama\_1 & 30111 & 8967 & 64.7 & 19.3\\
\hline
retama\_2 & 31366 & 7529 & 67.4 & 16.2\\
\hline
retama\_3 & 24007 & 12216 & 51.6 & 26.3\\
\hline
stipa\_1 & 20840 & 10547 & 44.8 & 22.7\\
\hline
stipa\_2 & 27698 & 12885 & 59.5 & 27.7\\
\hline
stipa\_3 & 13963 & 2049 & 30.0 & 4.4\\
\hline
\end{tabular}}
\end{table}
