...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{moiscrust }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(}
\NormalTok{    interpolated }\OperatorTok{==}\StringTok{ }\OtherTok{FALSE}\NormalTok{,}
\NormalTok{    microsite }\OperatorTok{==}\StringTok{ "stipa"}\NormalTok{,}
\NormalTok{    year }\OperatorTok{==}\StringTok{ }\DecValTok{2010}
\NormalTok{  ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{aes}\NormalTok{(}
    \DataTypeTok{x =}\NormalTok{ date_time,}
    \DataTypeTok{y =}\NormalTok{ soil_moisture,}
    \DataTypeTok{color =}\NormalTok{ sensor}
\NormalTok{  ) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{geom_line}\NormalTok{() }\OperatorTok{+}\StringTok{ }
...
\NormalTok{    interpolated }\OperatorTok{==}\StringTok{ }\OtherTok{FALSE}\NormalTok{,}
\NormalTok{    microsite }\OperatorTok{==}\StringTok{ "stipa"}\NormalTok{,}
\NormalTok{    year }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{2009}\NormalTok{, }\DecValTok{2010}\NormalTok{, }\DecValTok{2011}\NormalTok{)}
\NormalTok{  ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{group_by}\NormalTok{(year, year_day) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{summarise}\NormalTok{(}
    \DataTypeTok{soil_moisture =} \KeywordTok{mean}\NormalTok{(soil_moisture, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{    ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{aes}\NormalTok{(}
    \DataTypeTok{x =}\NormalTok{ year_day,}
    \DataTypeTok{y =}\NormalTok{ soil_moisture,}
    \DataTypeTok{color =} \KeywordTok{factor}\NormalTok{(year)}
\NormalTok{  ) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{geom_line}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{theme_bw}\NormalTok{()}
\end{Highlighting}
...
\includegraphics{moiscrust_files/figure-latex/unnamed-chunk-36-1.pdf}

\hypertarget{plotting-the-daily-average-of-each-microsite-for-a-given-set-of-years}{%
\subsection{Plotting the daily average of each microsite for a given set
of
years}\label{plotting-the-daily-average-of-each-microsite-for-a-given-set-of-years}}

This case is very similar to the previous one, but here we remove the
filter by microsite, and group by two variables instead:
\texttt{date\_time\_id} and \texttt{microsite}.
...
\NormalTok{    year }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{2009}\NormalTok{, }\DecValTok{2010}\NormalTok{, }\DecValTok{2011}\NormalTok{)}
\NormalTok{  ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{group_by}\NormalTok{(year, year_day, microsite) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{summarise}\NormalTok{(}
    \DataTypeTok{soil_moisture =} \KeywordTok{mean}\NormalTok{(soil_moisture, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{),}
\NormalTok{    ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{facet_wrap}\NormalTok{(}\StringTok{"year"}\NormalTok{, }\DataTypeTok{ncol =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{aes}\NormalTok{(}
    \DataTypeTok{x =}\NormalTok{ year_day,}
    \DataTypeTok{y =}\NormalTok{ soil_moisture,}
    \DataTypeTok{color =} \KeywordTok{factor}\NormalTok{(microsite)}
\NormalTok{  ) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{geom_line}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{theme_bw}\NormalTok{()}
\end{Highlighting}
...
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{facet_wrap}\NormalTok{(}\StringTok{"year"}\NormalTok{, }\DataTypeTok{ncol =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{aes}\NormalTok{(}
    \DataTypeTok{x =}\NormalTok{ soil_moisture,}
    \DataTypeTok{y =}\NormalTok{ microsite}
\NormalTok{  ) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{geom_boxplot}\NormalTok{(}\DataTypeTok{notch =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{theme_bw}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{moiscrust_files/figure-latex/unnamed-chunk-38-1.pdf}

\hypertarget{graphical-modeling-of-temporal-trends}{%
\subsection{Graphical modeling of temporal
trends}\label{graphical-modeling-of-temporal-trends}}

To model the temporal trends of the sensors (daily means over the years)
for a given microsite the data must be grouped by \texttt{year},
\texttt{year\_day}, and \texttt{microsite}. Adding a loess and a linear
fit to the plot allows to quickly check temporal trends on each sensor
...
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(}
\NormalTok{    interpolated }\OperatorTok{==}\StringTok{ }\OtherTok{FALSE}\NormalTok{,}
\NormalTok{    microsite }\OperatorTok{==}\StringTok{ "biocrust_low"}
\NormalTok{  ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{group_by}\NormalTok{(year, year_day, sensor) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{summarise}\NormalTok{(}
    \DataTypeTok{soil_moisture =} \KeywordTok{mean}\NormalTok{(soil_moisture, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{),}
\NormalTok{    ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{facet_wrap}\NormalTok{(}\StringTok{"sensor"}\NormalTok{, }\DataTypeTok{ncol =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{aes}\NormalTok{(}
    \DataTypeTok{x =}\NormalTok{ year,}
    \DataTypeTok{y =}\NormalTok{ soil_moisture}
\NormalTok{  ) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{geom_jitter}\NormalTok{(}\DataTypeTok{width =} \FloatTok{0.25}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.1}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{col =} \StringTok{"red4"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"lm"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"blue4"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{theme_bw}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{moiscrust_files/figure-latex/unnamed-chunk-39-1.pdf}

\hypertarget{comparing-temporal-trends-by-microsite}{%
\subsection{Comparing temporal trends by
microsite}\label{comparing-temporal-trends-by-microsite}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{moiscrust }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(}
\NormalTok{    interpolated }\OperatorTok{==}\StringTok{ }\OtherTok{FALSE}
\NormalTok{  ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{group_by}\NormalTok{(year, year_day, microsite) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{summarise}\NormalTok{(}
    \DataTypeTok{soil_moisture =} \KeywordTok{mean}\NormalTok{(soil_moisture, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{),}
\NormalTok{    ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{ggplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{facet_wrap}\NormalTok{(}\StringTok{"microsite"}\NormalTok{, }\DataTypeTok{ncol =} \DecValTok{1}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{aes}\NormalTok{(}
    \DataTypeTok{x =}\NormalTok{ year,}
    \DataTypeTok{y =}\NormalTok{ soil_moisture}
\NormalTok{  ) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{geom_jitter}\NormalTok{(}\DataTypeTok{width =} \FloatTok{0.25}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.1}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{method =} \StringTok{"lm"}\NormalTok{, }\DataTypeTok{col =} \StringTok{"red4"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{theme_bw}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
